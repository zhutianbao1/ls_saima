...
function timeId(){
    return date('YmdHis').getMicrotime().'_'.mt_rand();
}

function timeId1(){
    return date('YmdHis').getMicrotime();
}

//资金类型
function feeType($typeId=0){
    $arr = array(
            1=>'充值D币',
            10=>'支付D币',
            2=>'充值记录',
...
//curl
function https_request($url,$data = null,$charset=''){
	$curl = curl_init();
